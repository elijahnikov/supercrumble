...
interface FilmPageComponentProps {}

const FilmPageComponent = ({}: FilmPageComponentProps) => {
            ...
            <div className='mb-20 flex justify-center'>
                <div className='pageFrame'>
                    {fetchLoading || movieData.success === false ? (
                        ...
                        <>
                            <div className='mt-[100px] p-7'>
                                <br />
                                <div className='float-left w-[25%] text-center'>
                                    <img
                                        className='mb-5 inline aspect-auto h-[300px] cursor-pointer rounded-md '
                                        src={`https://image.tmdb.org/t/p/original${movieData.poster_path}`}
                                    />
                                    {/* <br />   */}
                                    <Button className='h-[35px] w-[120px] text-sm'>
                                        Add Review
                                    </Button>
                                    <div className='mt-5'>
                                        <FilmActions />
                                ...
                                <div className='float-left mt-[180px] ml-5 w-[720px]'>
                                    ...
                                    <span className='break-word inline text-[34px] font-bold text-white'>
