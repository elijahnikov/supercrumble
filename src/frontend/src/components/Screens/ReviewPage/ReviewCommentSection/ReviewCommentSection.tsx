...
import ReviewCommentReply from './components/ReviewCommentReply/ReviewCommentReply';
        ...
        <div>
            <div className='mb-10'>
                ...
                <div className='relative mt-[70px]'>
                    {data?.reviewComments.reviewComments.map((d) => (
                        <div
                            key={d.id}
                    ...
                    {data && data.reviewComments.hasMore ? (
                        <div className='flex'>
                            <Button
